...
const _AnimatedGIF = class extends pixi_js.Sprite {
  ...
  static fromBuffer(buffer, options) {
    ...
    const frames = [];
    const canvas = pixi_js.DOMAdapter.get().createCanvas(gif.lsd.width, gif.lsd.height);
    const context = canvas.getContext("2d", {
      willReadFrequently: true
    });
    const patchCanvas = pixi_js.DOMAdapter.get().createCanvas();
  ...
  update(ticker) {
    ...
    const elapsed = this.animationSpeed * ticker.deltaTime / pixi_js.Ticker.targetFPMS;
  ...
  clone() {
    const clone = new _AnimatedGIF([...this._frames], {
